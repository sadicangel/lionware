...
public sealed class Dbf31_should : IClassFixture<Dbf31_fixture>
{
    private readonly Dbf31_fixture _fixture;

    public Dbf31_should(Dbf31_fixture fixture) => _fixture = fixture;
    ...
    [Fact]
    public void Return_77_for_RecordCount()
    {
        Assert.Equal(77, _fixture.ReadOnlyDbf.RecordCount);
    }

    [Fact]
    public void Return_13_for_FieldCount()
    {
        Assert.Equal(13, _fixture.ReadOnlyDbf.Schema.FieldCount);
    }
